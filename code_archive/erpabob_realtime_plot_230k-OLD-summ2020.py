...
class PayloadPlot(QtGui.QMainWindow):
    ...
    def __init__(self, port):
        ...
        self.dataFile = open('data_file_230k'+myshield+'.txt', 'w')
        self.closed = False
        time.sleep(10)
        self.rawData = ''
        ...
        # Open file to write to 
  #      self.dataFile = open('data_file_230k-shield_'+str(self.payload.shieldID[0])+'.txt', 'w')
  #      self.closed = False
  #      time.sleep(10)
  #      self.rawData = ''
